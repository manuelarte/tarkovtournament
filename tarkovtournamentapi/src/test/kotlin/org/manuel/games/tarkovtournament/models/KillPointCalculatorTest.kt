...
class KillPointCalculatorTest {
    ...
    fun deserializingTypeDefault() {
        val factionsObject = JSONObject()
        factionsObject.put("scav",1)
        factionsObject.put("pmc",2)
        val rootObject= JSONObject()
        rootObject.put("type","byFaction")
        rootObject.put("factions", factionsObject)
        rootObject.put("defaultPoints", 1)
    ...
    fun serializingTypeDefault() {
        val pointCalculator: KillPointCalculator = FactionKillRule(factions = mapOf(Pair("scav",1.0), Pair("pmc", 2.0)), defaultPoints = 1.0)

        val factionsObject = JSONObject()
        factionsObject.put("scav",1)
        factionsObject.put("pmc",2)
        val expected= JSONObject()
        expected.put("type","byFaction")
        expected.put("factions", factionsObject)
